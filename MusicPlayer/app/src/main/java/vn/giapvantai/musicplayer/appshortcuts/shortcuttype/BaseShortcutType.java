package vn.giapvantai.musicplayer.appshortcuts.shortcuttype;
...
import vn.giapvantai.musicplayer.appshortcuts.AppShortcutLauncherActivity;

@TargetApi(Build.VERSION_CODES.N_MR1)
public abstract class BaseShortcutType {

    static final String ID_PREFIX = "vn.giapvantai.musicplayer.appshortcuts.id.";
